<html>
	...
	<body>
		...
		<div class="row">
			<div class="tab">
				<button class="tablinks" onclick="openCity(event, 'Cart')" id="defaultOpen">Cart</button>
				<button class="tablinks" onclick="openCity(event, 'Previous_Products')">Previous Products</button>
			</div>
				...
				<div class="ex1">
					<?php
						for($i=0 ;$i<20 ;$i++)
						{
							...
							echo '		<br><a href="#news">Order again</a>';
							echo '</div></div>';
						}
					?>
				</div>
